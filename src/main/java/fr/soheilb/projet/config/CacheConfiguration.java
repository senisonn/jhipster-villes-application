package fr.soheilb.projet.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.soheilb.projet.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.soheilb.projet.repository.UserRepository.USERS_BY_EMAIL_CACHE);
